...
\texttt{MUUTA KUVA JA TEKSTI MARKON VASTAUKSESTA RIIPPUEN}
\begin{figure}[H]
  	\centering
...
The practical implementation of the research study took place between August and NOVEMBER???? 2013. Altogether seven users from two different countries contributed in the study by participating the usability evaluation sessions. The only usability inspection method, the Cognitive Walkthrough, was utilized by one analyst. The usability evaluation methods used were remote data logging, Contextual Inquiry and Interaction Sequence Illustration evaluations. The participants also filled in the System Usability Scale form. The users' work experience varied from under a year to twenty five years. In every evaluation session the users were situated in their own workstations. 
...
The study was implemented in two phases. The aim of the first evaluation round was to gain understanding about the current system, including its deficiencies and assets. The focus was set for understanding the process and the way user's are utilizing the system in their everyday work. The objective of the second iteration on the other hand was to evaluate and redefine the requirements of the new system (gathered with the usability methods). In practice, this was accomplished by using the usability methods to evaluate the created prototype.

  \texttt{THE FIRST ITERATION AND THE SECOND??? OR METHOD BY METHOD.}

The first part of the first iteration encompassed the Contextual Inquiry, Remote Contextual Inquiry, System Usability Scale, Interaction Sequence Illustration and Cognitive Walkthrough. Contextual Inquiry was utilized first with the ISI method in Finland, in order to gain understanding about the context of use. Overall four users participated in the inquiry. After the inquiry, Interaction Sequence Illustration 
