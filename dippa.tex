...
PLANNING setting project focus: define the problem you intend to solve -  designing the inquiry: 

-structure -the conventional interview: introduction, ask permission to record, explain that the work of user is primary and he need to teach me the stuff and correct misunderstandings, overview  about the job- the transition: rules, interrupting is okay, bad time for interrupting - contextual interview proper: observing, asking questions, suggesting interpretations, notes, be nosy -the wrap-up: wrap-up understanding, summarize, 
