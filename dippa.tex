...
\label{sec:sum}
\section{Single, standardized and summated usability metric}
    \begin{itemize}
        \item Cognitive stress?
        \item Orders/Invoices/Claims handled in certain period of time?
        \item The amount of interactions?
        \item Comparison between countries?
    \end{itemize}
...
\chapter{Process implementation}
\label{processimplementation}

Introduction to the chapter.
What will be done and which methods are used. 

\label{sec:methods}
\section{Single, standardized and summated usability metric (SUM)?}
    \begin{itemize}
        \item Cognitive stress?
        \item Orders/Invoices/Claims handled in certain period of time?
        \item The amount of interactions?
...
\label{sec:steps}
\begin{itemize}
    \item Creating the fond for gathering data
    \item Modified contextual inquiry, SUM
    \item Analysis 1.
    \item Prototype creation
    \item Remote evaluation, SUM
\end{itemize}
