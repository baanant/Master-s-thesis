...
% ------------------------------------------------------------------
\newcommand{\TITLE}{Usability methods as a part of ERP software development process}
...
\newcommand{\KEYWORDS}{Usability, ERP, sofware development process, process measurement, nasa tlx, remote usability evaluation,SUS, contextual inquiry}
\newcommand{\FKEYWORDS}{Käytettävyys, ERP, ohjelmistokehitysprosessi, prosessimittaus, nasa tlx, käytettävyyden etäarviointi, SUS, kontekstuaalinen tutkimus}
...
\label{chapter:intro}
    \begin{itemize}
        \item Introduction to the topic and motivation of the thesis.
        \item Introduction to the research problem.
        \item Introduction to the methods.
...
Deeper introduction to the problem 
\begin{itemize}
...
\section{Process measurement methods}
    \begin{itemize}
        \item SUS
        \item NASA TLX \cite{hart1988development}
...
\chapter{Process implementation and analysis}
\label{processimplementation}
Introduction to the chapter.
