...
\\
\\
\indent According to ISO standard for Human-centred design for interactive systems \cite{RefWorks:16}, many benefits can be gained by using human-centred methods as a part of software development process. The productivity of an individual user can be increased, as well as the operational efficiency of an organisation. Usable and useful systems also reduce training and help-desk costs together with stress and discomfort since they are understandable by the users. In other words, human-centred design improves the UX (User Experience).
...
Human-centred design consist of a few activities and and iterative process.  
This chapter describes the process experiment of the thesis, including the explicit report about the steps taken in the process. 
\begin{figure}[h!]
  \centering
    \includegraphics[width=1.0\textwidth]{./images/hci_process.png}
  \caption{A picture of a gulli.}
\end{figure}
