...
In this chapter, the background and the reasoning for the thesis is described together with the focus and the limits of the research scope. 
...
Introduction to the chapter.
    ...
    \label{sec:measurement}
        ...
        \subsection{NASA-TLX} 
            NASA-TLX is build by NASA.\cite{hart1988development}
