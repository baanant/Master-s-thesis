...
The aim of this thesis is to examine if the usability of an ERP system can be enhanced by integrating usability inquiries, inspections and measures into software development process. In the research, one well specified business process is examined and variety of usability methods will be used to define the usability of this process in the system. Contextual inquiry is used to define the business , 
\section{Background}
