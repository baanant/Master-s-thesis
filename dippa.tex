...
During the research, it is essential to create collaborative environment and a \textbf{partnership} between the user and the interviewer. 

-traditional interview gives too much power to interviewer while apprentice gives too much power to user.
-user -> expert of the work, interviewer -> should be experts in seeing the work structure.
-interviewer  should create something like partnership 
-interviewer must make user aware of the hidden details in work.
-user must tell why he's doing something. 
- By paying attention to the details and structure of work, interviewer teaches the user to attend to them also.
-withdrawal and return 
-best case = partnership for watching work structure and thinking about design possibilities.
- interviewer should not think about technology = distraction.
- 
