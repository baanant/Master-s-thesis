...
This thesis contains research about usability of in-house software development process and the scope does not include any other aspects of the process. The literature part of the research consists of a few usability methods and even though the target for the research is ERP software, literature about ERP systems are not covered in the thesis. The results of the research may not be suitable for every organization.
