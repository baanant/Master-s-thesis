...
\newcommand{\KEYWORDS}{Usability, User interface, ERP, Software development process, Process measurement, Cognitive Walkthrough, Remote usability evaluation, Automatic usability logging, SUS, Contextual Inquiry, ISI, Software process improvement, RCI, Usability Maturity Model, CMMI}
\newcommand{\FKEYWORDS}{Käytettävyys, Käyttöliittymä, ERP, Ohjelmistokehitysprosessi, Prosessimittaus, Kognitiivinen läpikäynti, Käytettävyyden etäarviointi, Automaattinen käytettävyyslokitus, SUS, Kontekstuaalinen tutkimus, ISI, Ohjelmistoprosessin kehitys, RCI, Käytettävyyden kypsyysmalli, CMMI}
...
\hyphenation{di-gi-taa-li-sta yksi-suun-tai-sta ana-ly-sis pro-duct imp-le-men-ta-ti-on o-pe-ra-ti-o-nal u-sa-bi-li-ty}
...
Tässä työssä tutkitaan mahdollisuutta parantaa yrityksen sisällä tapahtuvaa ohjelmistokehitysprosessia hyödyntämällä ISO standardia (ISO 9241-210 Ihmisen ja järjestelmän vuorovaikutuksen ergonomia) toiminnanohjausjärjestelmän kehityksessä. Kehitys on pyritty havaitsemaan vertaamalla käytettävyyden ja tuotekehityksen kypsyysmallien tasoa ennen kuin ihmisläheisen suunnittelun toiminnot on lisätty ohjelmistokehitysprosessiin ja sen jälkeen. Lisäksi tutkielmassa pyritään määrittelemään joukko käytettävyysmenetelmiä, jotka voidaan vaivattomasti liittää osaksi yrityksen sisäistä ohjelmistokehitysprosessia, ja joilla voidaan havaita mahdolliset toiminnanohjausjärjestelmän käytössä ilmenevät kulttuurierot.

Tutkielmassa joukko käytettävyysmenetelmiä on liitetty ihmisläheisen suunnittelun perustoimintoihin, jonka jälkeen yhtä toiminnanohjausjärjestelmän prosesseista on tutkittu soveltaen ihmisläheisen suunnittelun periaatteita ja käytettävyysmenetelmiä. Aluksi osaa käytettävyysmenetelmistä hyödynnetään käyttökontekstin ymmärtämiseksi ja käyttettävyysvaatimuksien määrittelemiseksi. Sen jälkeen luodaan käyttöliittymämalleja ja korkean tason prototyyppi käytettävyysvaatimusten mukaisesti. Lopuksi tutkielmassa arvioidaan käytettävyysmenetelmien avulla vastaavatko käyttöliittymämallit käytettävyysvaatimuksiin. 
...
%This study examines the possibility to improve in-house software development process by applying the ISO standard Human-centered design for interactive systems, in the development of an Enterprise Resource Planning (ERP) system. Improvement of the process is tried to identify by comparing the Usability Maturity Model (UMM) and Capability Maturity Model Integration (CMMI) levels before and after the applied human-centered design is attached as a part of the software development process. The study also aims to define a suitable set of usability methods which can be attached to the in-house software development process, and used to identify possible cultural differences in the usage of the ERP system.
%
%A set of usability methods are joined with the human-centered design activities. A process of the ERP system is then examined by applying the principles of human-centered design and the usability methods. Firstly, a subset of methods is used to understand and specify the process's context of use, and to specify the user requirements. Secondly, mock-ups and a high-fidelity prototype are created to produce design solutions to meet user requirements. Finally, the created designs are evaluated against the user requirements by utilizing a subset of evaluation methods.  
%
%The results are diverse. Applying the usability methods as a part of human-centered design activities produced wide scale of usability issues and requirements, as well as identified cultural differences in the usage of the system. Additionally, the study resulted a source code for remote usability logging, mock-ups, a prototype and recommendations about the utilization of the methods. However, the main result of the study is a conclusion that the Usability Maturity Model and Capability Maturity Model Integration levels can be increased, and thereby in-house software development process can be improved, by applying the human-centered design activities and usability methods.
