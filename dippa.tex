...
\label{sec:measurement}
	...
	SUS is a simple way to get subjective views about the usability of a system. It is a ten-item \emph{Likert scale}, meaning that every item consist of the scale of five ranging from "strongly disagree" to "strongly agree". \cite{RefWorks:10}
