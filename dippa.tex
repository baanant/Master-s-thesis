...
Despite the importance of the efficiency aspect, usability of ERP systems is not a widely studied topic. However, the fact is that weaknesses in usability may lead into a low productivity and make it harder for users to achieve their goals.\cite{erpusability}

The aim of this thesis is to examine if the usability of a service-oriented ERP system can be enhanced by integrating usability inquiries, inspections and measures into the software development process. In the research, one well defined business process is examined and variety of methods will be used to determine the state of the processes' usability in the system:
\begin{itemize}
...
\item System Usability Scale (SUS) to give a global view of subjective assesments of usability
\item Remote Usability evaluation and Usability logging for remote usability evaluation
\end{itemize}
The measurements will be focused on time, error rate and user safisfaction.

\section{Background and research problems}
\label{sec:background}
The subscriber of this thesis is a middle-sized company which is offering information services globally and practicing in-house software development. Because of the fast pace of growth, the company is willing to reform their current ERP system as well as the whole software development process. The results of this thesis will be used in defining the software development process.  

-Can usability methods be used in identifying differences between working methods (same system, same process), and thus find the most efficient way of doing things and help to develope more efficient system.
-How usability affects on efficiency of the process.
-How much including usability aspects into a software development process will affect on user satisfaction.
