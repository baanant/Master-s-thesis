...
The aim of this thesis is to examine if the usability of an ERP system can be enhanced by integrating usability inquiries, inspections and measures into software development process. In the research, one well defined business process is examined and variety of methods will be used to determine the state of the processes' usability in the system:
\begin{itemize}
...
\end{itemize}The measurements will be focused on time, error rate and user safisfaction.
