...
The subscriber of this thesis is a middle-sized company which is offering information services globally and practicing in-house software development. Because of the fast pace of growth, the company is willing to reform their current ERP system as well as the whole software development process. The results of this thesis will have possible impacts on the process. 

Many reasons for including the usability perspective as a part of software development process
Including the usability perspective as a part of software development process is considered for 
        \begin{itemize}
            \item general info about the business
                \begin{itemize}
