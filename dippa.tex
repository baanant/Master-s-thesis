...
%        \end{itemize}
%    
\section{The scope and structure of the thesis}
\label{sec:thescopeandstructureofthethesis}

This thesis contains research about usability of in-house software development process and the scope does not include any other aspects of the process. The usability perspective is examined as such and 

-only few usability methods used
