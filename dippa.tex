...
\section{Automated Usability Logging}
\label{sec:rue}

Logged usage data of an application can offer valuable information about users' actions and can therefore be utilized in improving software usability. Logging provides many advantages over 
