...
The purpose of the Enterprise Resource Planning (ERP) software is to offer techniques and concepts for integrated, thorough, management of business as well as making it more efficient. The usage of the ERP software has increased globally and is now used in varied types of industry.\cite{erp1} However, 
