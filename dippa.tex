...
As described earlier, the subscriber company operates globally and its tailored ERP system is used in all country offices. The company has also customer service functions in every office which 
...
Interaction Sequence Illustration method is used in the thesis, together with the workflow diagram, to identify and represent the interaction steps required to accomplish the customer creation process. The method was chosen because one of the main objectives of this thesis \emph{is to find out how much the efficiency of use can be affected by utilizing the results of usability evaluation}. ISI can be used not only to identify all the interaction steps, but to detect the unnecessary steps as well. If the unnecessary phases can be excluded from the process, it might have significant affects on the efficiency of use and reveal tacit user requirements. ISI can be perceived also as a method for the process of understanding and specifying the context of use. 

The user experience might have influence on the efficiency of use. This is why the UX of the system should be considered even if the company's distinctive ERP system is developed for the use of experts. The System Usability Scale is being used to understand the level of user satisfaction. As ISI, also the SUS can answer to two steps of human-computer design process: Understanding and specifying the context of use and specifying the user requirements. 

Traditional and continuous usability evaluation would be difficult and expensive for the subscriber company because of its distributed operational environment. Hence, the possibility of accommodating remote usability evaluation to the company's software development process is examined in this thesis. Remote usability evaluation in this context means the remote usability related user interface data logging. The desirable results from using the data logging would be utilizable, location independent usability data, which could help the development of the global ERP system and reveal user requirements. Naturally, the remote usability evaluation in this thesis concentrates on the process of customer creation.
...
After the user requirements have been specified, \emph{design solution can be produced according to these requirements}. 
...
\end{figure}
        ...
        \begin{itemize}
            \item Planning the design process
