...
% ------------------------------------------------------------------
\newcommand{\TITLE}{Usability inquiring and testing as a part of ERP software development process}
\newcommand{\FTITLE}{Käytettävyystutkimus ja -testaus osana ERP-ohjelmistokehitysprosessia}
