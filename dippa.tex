...
In this chapter, the background and reasoning for the thesis is described together with the focus and limitations of the research. In the text, research problems and the structure of the thesis will be also defined. TEST
...
It is important to find the most effective and usable user interface solutions and thus decrease the average time of tasks. Local differences can be tracked with remote usability measurements.

\item \textbf{\emph{What usability methods can be practically joined to the software development process of the ERP system?}}

Finding the practical and efficient usability methods to be joined into software development process can improve the quality of the end product.
...
This thesis covers research about usability of in-house software development process and the scope does not include any other aspects of the process. The literature part of the research consists of a few usability methods and even though the target of the research is an ERP software, literature about ERP systems are not covered in the thesis. The results of the research may not be suitable for every organization.
