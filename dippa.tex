...
There are many ways to implement remote usability evaluation. In this paper, the data logging approach is introduced. In the context of usability, logging means practices for mechanically recording the usage of a system.
