...
The purpose of the Enterprise Resource Planning (ERP) software is to offer techniques and concepts for integrated and thorough management of business, as well as making it more efficient. The usage of ERP software has increased globally and is now used in varied types of industry.\cite{erp1} 

Despite the importance of the efficiency aspect, the usability of ERP systems is not a widely studied topic. However, weaknesses in usability may lead into a low productivity and make it harder for users to achieve their goals.\cite{erpusability}
