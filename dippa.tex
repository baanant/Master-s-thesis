...
The first stage of the first phase encompassed the Contextual Inquiry, Remote Contextual Inquiry, System Usability Scale, Interaction Sequence Illustration and Cognitive Walkthrough. Contextual Inquiry was utilized first together with the ISI method in Finland. Overall four users participated in the inquiry with the working experience from half a year to 21 years. The aim of this  stage was to gain understanding about the context of use and test the methods in practice. The desirable situation would have been the one where the ISI could have been used to measure the average time of the customer creation process and that the Contextual Inquiry would have been targeted on a real customer creation situation. During the first inquiry, it cleared that the users don't have enough real-life cases to be used in Contextual Inquiry and Interaction Sequence Illustration. Also, the practical implementation of the process turned out to be changing according to the customers' needs, provided information and the customer service representative's conventions, so it came clear that measuring the time of completing the process was not a good idea. Because the same reason, utilizing the ISI became more difficult. To make the implementation of Interaction Sequence Illustration beneficial, a sequence of tasks were created according to the assumed customer creation process and the users were asked to accomplish those tasks. The activities were recorded and the users were asked to notify all the problems in the assumed process. This way it was possible to refine the stages and the interaction steps of the conventional customer creation process. 

During the interviews the customer service representatives had only some parts of the customer creation process in their to-do lists. Because the lack of real-life cases, the users were executing the customer management artificially during the inquiries. This was enabled by using the test environment of the system. The authentic parts of the inquiries were naturally implemented in the production environment. 



\subsection{Phase 2: Building an evaluating the high-fidelity prototype}

The first stage of the first phase encompassed the Contextual Inquiry, Remote Contextual Inquiry, System Usability Scale, Interaction Sequence Illustration and Cognitive Walkthrough. Contextual Inquiry was utilized first with the ISI method in Finland, in order to gain understanding about the context of use. Overall four users participated in the inquiry. After the inquiry, Interaction Sequence Illustration 
...
\texttt{ALSO MOCKUPS AND STORYBOARDS, SEQUENCE DIAGRAMS AND USE CASES ARE BEING DONE DURING THE THESIS.}
