...
Introduction to the topic and motivation of the thesis.
...
- general info about the business

        \leftskip- information services
    
        \indent- publication delivery
    
        \indent- database services
    
- general info about the company

        \indent- middle-sized, ~200 employees
    
        \indent- fast pace of growth
    
        \indent- personnel service
    
- what will be done

        \indent- SOA 
    
        \indent- new process model for software development

\section{Research problems}

Deeper introduction to the problem 

- Efficiency differences in country offices.

- Need for more efficient ERP.
