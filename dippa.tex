...
The analysis was implemented in two phases according to the two evaluation rounds with the old ERP system and the new prototype. The first analysis was done after the first evaluation round and before designing the prototype. The focus on the Contextual Inquiry and the Remote Contextual Inquiry analyzes were on understanding the context of use and how the users are using the old ERP system. The selected data display for analyzing the inquiries were affinity diagrams. The gathered study material was examined and organized into a wider categories which then implicated the results of the first inquiries. 
...
After the prototype was created, approximately same analysis actions were taken to examine the differences between the two implementations. Still, there were few differences. On the second phase the focus of analyzing the inquiries was on redefining the requirements and the design solutions. In the Interaction Sequence Illustration analysis the focus was on capturing the stages of the customer creation process and because of the reasons mentioned earlier, it was impossible to calculate the specific amount of interaction steps. Also, because of that the analysis of the remote usability logging was focused mostly on it's possibilities in measuring the usability of the system. 
