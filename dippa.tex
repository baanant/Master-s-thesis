...
Defining the users is important part of preparations. If the background and technical experience of the users are described in the beginning, more details can be possibly revealed in the walkthrough itself. Analysis should be also limited to a moderate amount of tasks and the selection of task for analysis is critical. The selection should be based on facts, such as requirement analysis, needs analysis or concept testing. Tasks from the core functionality should be chosen and some of the basic tasks should be combined. Preparations should also include description of task contexts. \cite{RefWorks:26}
