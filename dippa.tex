...
In this section the results of the thesis will be reviewed. Firstly, the results of utilizing the usability methods will be explained in two phases: The results gathered by evaluating and analyzing the data of the old ERP system, and the data of the created prototype. Secondly, the overview of the differences between the two user interfaces will be described. Finally, the user interface and the different sections of the prototype will be presented in a general manner. Because of confidentiality reasons, the usability evaluation results are not described in detail.
...
Because of the time schedule limitations, only the Swedish users took part on the second evaluation round. The inquiries were implemented remotely and the product to be evaluated was the created user interface prototype. 
