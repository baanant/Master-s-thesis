...
Traditional and continuous usability evaluation would be difficult and expensive for the subscriber company because of its distributed operational environment. Hence, the possibility of accommodating remote usability evaluation to the company's software development process is examined in this thesis. Remote usability evaluation in this context means the remote usability related user interface data logging. The desirable results from using the data logging would be utilizable, location independent usability data, which could help the development of the global ERP system. Naturally, the remote usability evaluation in this thesis concentrates on the process of customer creation.

Expert evaluation is utilized using Cognitive Walkthrough. The objective of CW in the thesis is to identify user requirements which are not distinctive and cannot be perceived from the user evaluations. Cognitive Walkthrough is used to ensure that any crucial requirements will not stay unnoticed. 
