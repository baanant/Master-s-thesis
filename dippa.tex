...
There is no guarantee about the reliability of the remote usability logging data, because there's hardly none available, and the method requires an authentic environment. Nevertheless, the created library functions well, and the sample data corresponds to actions taken in the user interface. The results of the Contextual Inquiry and the Remote Contextual Inquiry seems highly reliable. The hypothesis is supported by the fact that the results of the last inquiries from both evaluation rounds started to recur and no new discoveries were made. 
...
In general, the research study was successful and it produced desired results. 
