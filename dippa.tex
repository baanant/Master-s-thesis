...
\label{sec:measurement}
	...
	Interaction Sequence Illustration uses data acquired during the contextual inquiry and doesn't gather any of its own. However, the inquiry data has to be complemented with data about every interaction step, for example by capturing the screen activity.				The strength of ISI lies in the analysis of data. 
