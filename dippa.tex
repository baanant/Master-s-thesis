...
Human-centered design doesn't require any particular design process, and it functions as a supplement to existing design methodologies. However, there are some principles which should be followed in order the process to be human-centered. First, the understanding of users, tasks and environments should create the basis for the design. 
