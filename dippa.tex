...
\item Cognitive walktrough for usability inspection
...
\end{itemize}
The measurements will be focused on time, error rate and user satisfaction.
...
-Can usability methods be used in identifying differences between working methods (same system, same process), and thus find the most efficient way of doing things and help to develop more efficient system.
